...
_rombo3D::_rombo3D(float tam, float al, float desp)
{
	// vertices
	vertices.resize(6); // 6 vertices
	vertices[0].x=-tam+desp;vertices[0].y=al/2;vertices[0].z=0;
	vertices[1].x=desp;vertices[1].y=0;vertices[1].z=0;
	vertices[2].x=desp;vertices[2].y=al/2;vertices[2].z=tam;
	vertices[3].x=tam+desp;vertices[3].y=al/2;vertices[3].z=0;
	vertices[4].x=desp;vertices[4].y=al/2;vertices[4].z=-tam;
	vertices[5].x=desp;vertices[5].y=al;vertices[5].z=0;
